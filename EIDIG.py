...
def global_direction_comparison(X, seeds, num_attribs, protected_attribs, constraint, model, decay):
...
'''
# def local_generation(num_attribs, l_num, g_id, protected_attribs, constraint, model, update_interval, s_l, epsilon):
def local_probability_comparision(seeds, num_attribs, protected_attribs, constraint, model, epsilon):
    # local generation phase of EIDIG
